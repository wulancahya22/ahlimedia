            ...
            <tr>
              <td>
                <center><img src="<?php if ($user['foto'] == NULL) {
                                    echo base_url('assets2/img/profile.jpg');
                                  } else {
                                    echo base_url("/assets2"); ?>/img/<?php echo $user['foto'];
    ...
    <div class="card-body">
      <form action="" method="post">
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" name="no_identitas" disabled value="<?php echo $user['nama']; ?>" class="form-control" size="4">
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" name="no_hp" disabled value="<?php echo $user['email']; ?>" class="form-control" size="4">
          </div>
        </div>
      </form>
    </div>
